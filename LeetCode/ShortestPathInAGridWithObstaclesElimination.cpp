#include "stdafx.h"
#include "ShortestPathInAGridWithObstaclesElimination.h"

#include <queue>

/*
This question can be solved using bfs. The obstacle make the visited matrix to be 3D.
visited[][][0~k], the third index i means if we remove i obstacle, whether the grid is visited. The states are (i, j, k),
where k is the number of obstacle removed. Space is visited matrix MNK, time is MNK
*/
