#include "stdafx.h"
#include "MaximumNumberOfNonOverlappingSubstrings.h"

#include <algorithm>

//Greedy, first find all possible valid subs, then for each character in s, 
//we check wether it is a shorter interval compared to the previous, remove the longer one.

vector<string> Solution::maxNumOfSubstrings(string s) {
  int n = s.size();
